...
data modify storage timber:op d set value {Tags:["timber.d","timber.b0"],Rotation:[0f,0f],teleport_duration:0,view_range:1.5f,block_state:{},transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[1f,1f,1f]}}
