...
$execute if score #k timber.data >= #rs timber.data positioned ~ ~0.5 ~ run particle minecraft:block{block_state:"$(leaf)"} ~ ~ ~ $(cw) $(cw) $(cw) 0.09 24
...
execute positioned ~ ~-0.3 ~ run particle minecraft:dust_plume ~ ~ ~ 0.35 0.05 0.35 0.02 3
