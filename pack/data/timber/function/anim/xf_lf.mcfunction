...
scoreboard players operation #x timber.data *= #lx timber.data
execute store result storage timber:anim xl.transformation.translation[0] float 0.000001 run scoreboard players get #x timber.data
...
scoreboard players operation #z timber.data *= #lz timber.data
...
execute store result storage timber:anim xl.transformation.translation[1] float 0.0000001 run scoreboard players get #ny timber.data
execute store result storage timber:anim xl.transformation.translation[2] float 0.0000001 run scoreboard players get #nz timber.data
data modify entity @s {} merge from storage timber:anim xl
